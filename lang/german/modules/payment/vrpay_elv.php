 ...
 */
	...
	define('MODULE_PAYMENT_VRPAY_ELV_INFOTEXT_DESC', 'Infotext (max. 1024 Zeichen). Folgende Platzhalter werden ersetzt: {$order_id}, {$customers_cid}, {$customers_name}, {$customers_lastname}, {$customers_firstname}, {$customers_company}, {$customers_city}, {$customers_email_address}');
	...
	define('MODULE_PAYMENT_VRPAY_ELV_TEXT_FAILED', 'Ihre Transaktion ist fehlgeschlagen. Bitte wählen Sie eine alternative Bezahlmethode.');
	define('MODULE_PAYMENT_VRPAY_ELV_TEXT_CANCELED', 'Transaktion abgebrochen. Bitte wählen Sie eine alternative Bezahlmethode.');
	define('MODULE_PAYMENT_VRPAY_ELV_TEXT_GATEWAY_UNAVAILABLE', 'Bezahlsystem vorübergehend nicht erreichbar. Bitte wählen Sie eine alternative Bezahlmethode.');	
	define('MODULE_PAYMENT_VRPAY_ELV_TEXT_GATEWAY_AUTHENTICATION', 'Anmeldung am Bezahlsystem fehlgeschlagen. Bitte wählen Sie eine alternative Bezahlmethode.');
	define('MODULE_PAYMENT_VRPAY_ELV_TEXT_UNKNOWN_ERROR', 'Ein unbekannter Fehler ist aufgetreten. Bitte wählen Sie eine alternative Bezahlmethode.');
	define('MODULE_PAYMENT_VRPAY_ELV_TEXT_CURRENCY_NOT_SUPPORTED', 'Die Währung wird von dieser Bezahlmethode nicht unterstützt. Bitte ändern Sie die Währung oder wählen Sie eine alternative Bezahlmethode.');
