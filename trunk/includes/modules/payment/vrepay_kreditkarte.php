...
//						'message' 	=> MODULE_PAYMENT_VREPAY_KREDITKARTE_TEXT_MSG01,
	...
	function install() {
		...
		xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) values ('MODULE_PAYMENT_VREPAY_KREDITKARTE_VERWENDUNG2', 'enjoy xtCommerce shopping', '6', '10', now())");
